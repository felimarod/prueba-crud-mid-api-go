...
// URLMapping ...
func (c *NumeroTelefonicoController) URLMapping() {
...
// @Param	body		body 	models.NumeroTelefonico	true		"body for NumeroTelefonico content"
// @Success 201 {int} models.NumeroTelefonico
// @Failure 403 body is empty
// @router / [post]
func (c *NumeroTelefonicoController) Post() {
	var v models.NumeroTelefonico
...
// @Success 200 {object} models.NumeroTelefonico
// @Failure 403 :id is empty
// @router /:id [get]
func (c *NumeroTelefonicoController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *NumeroTelefonicoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *NumeroTelefonicoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.NumeroTelefonico{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *NumeroTelefonicoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
